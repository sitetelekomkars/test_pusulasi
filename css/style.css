...
function startTicker() {
  ...
  // Sonsuz döngü efekti için metni 3 kez tekrarla
  const fullText = tickerText + ' &nbsp;&nbsp;&nbsp;&nbsp; • &nbsp;&nbsp;&nbsp;&nbsp; ' + tickerText + ' &nbsp;&nbsp;&nbsp;&nbsp; • &nbsp;&nbsp;&nbsp;&nbsp; ' + tickerText;
  t.innerHTML = fullText;

  // DÜZELTME: Metin uzunluğuna göre dinamik animasyon süresi hesapla (saniyede yaklaşık 100 piksel kayar)
  const duration = Math.max(30, Math.ceil(fullText.length / 10)); // Min 30 saniye
  
  // Animasyonu başlat (CSS'teki ticker-scroll keyframe'i sağdan sola kaydırıyor)
